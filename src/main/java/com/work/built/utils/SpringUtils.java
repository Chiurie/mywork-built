...
public class SpringUtils {
	 ...
	 */
	public static void render(HttpServletResponse responses,
			final String contentType, final String content,
			final String... headers) {
		HttpServletResponse response = initResponseHeader(responses,
				contentType, headers);
		try {
	 ...
	 */
	public static HttpServletResponse initResponseHeader(
	 ...
	 * 获取字符串中的数字
	 */
	public static Integer stringOfNum(String numStr) {
		String str = numStr;
		str = str.trim();
		String str2 = "";
